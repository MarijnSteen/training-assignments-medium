...
public class RDSJanitorResourceTracker implements JanitorResourceTracker {
    ...
    public void addOrUpdate(Resource resource) {
    	...
    	if (orig == null) {
    		StringBuilder sb = addToAWSResourceIfNull();
    		...
    		StringBuilder sb = addToAWSRecourceIfNotNull();
	...
	private StringBuilder addToAWSRecourceIfNotNull() {
	...
	private StringBuilder addToAWSResourceIfNull() {
		StringBuilder sb = new StringBuilder();
