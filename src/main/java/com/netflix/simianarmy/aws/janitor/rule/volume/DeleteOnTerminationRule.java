...
/**
 * The rule is for checking whether an EBS volume is not attached to any
 * instance and had the DeleteOnTermination flag set in the previous attachment.
 * This is an error case that AWS didn't handle. The volume should have been
 * deleted as soon as it was detached.
 *
 * NOTE: since the information came from the history, the rule will work only if
 * Edda is enabled for Janitor Monkey.
 */
public class DeleteOnTerminationRule extends VolumeRule {
	 ...
	 * @param retentionDays
	 *            The number of days that the volume is retained before being
	 *            terminated after being marked as cleanup candidate
	 */
	...
	@Override
	public boolean isValidSpecific(Resource resource) {
